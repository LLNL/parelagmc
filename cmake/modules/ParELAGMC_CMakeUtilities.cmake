# This is from ParELAGCMakeUtilities.cmake Thanks trb!
...
function(add_parelagmc_executables EXE_SRCS)
  # Add one executable per cpp file
  foreach(SRC_FILE IN LISTS ${EXE_SRCS})
    get_filename_component(SRC_FILENAME ${SRC_FILE} NAME)

    string(REPLACE ".cpp" ".exe" EXE_NAME ${SRC_FILENAME})
    add_parelagmc_executable(${EXE_NAME}
      MAIN ${SRC_FILE}
      LIBRARIES ${PROJECT_NAME})
  endforeach(SRC_FILE)
endfunction()

# A slightly more versitile function for adding executables to ParELAGMC
function(add_parelagmc_executable PARELAGMC_EXE_NAME)
  ...
  add_executable(${PARELAGMC_EXE_NAME} ${MAIN_LIST}
    ${EXTRA_SOURCES_LIST} ${EXTRA_HEADERS_LIST})
  
  # Append the additional libraries and options
  target_link_libraries(${PARELAGMC_EXE_NAME} PRIVATE ${LIBRARIES_LIST})
  target_compile_options(${PARELAGMC_EXE_NAME} PRIVATE ${EXTRA_OPTIONS_LIST})
  target_compile_definitions(${PARELAGMC_EXE_NAME} PRIVATE ${EXTRA_DEFINES_LIST})
  
  # Handle the MPI separately
  target_link_libraries(${PARELAGMC_EXE_NAME} PRIVATE ${MPI_CXX_LIBRARIES})

  target_include_directories(${PARELAGMC_EXE_NAME} PRIVATE ${MPI_CXX_INCLUDE_PATH})
  if (MPI_CXX_COMPILE_FLAGS)
    target_compile_options(${PARELAGMC_EXE_NAME} PRIVATE ${MPI_CXX_COMPILE_FLAGS})
  endif()
  
  if (MPI_CXX_LINK_FLAGS)
    set_target_properties(${PARELAGMC_EXE_NAME} PROPERTIES
...
function(parelagmc_determine_library_type lib_name output_var)
...
endfunction(parelagmc_determine_library_type lib_name output)
