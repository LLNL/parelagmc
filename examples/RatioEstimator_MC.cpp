...
// E_post[Q] = E[R]/E[Z] (sum, then divide), 
// and Splitting-E_post[Q]=E[R/Z] (divide, then sum) 
...
int main (int argc, char *argv[])
{
  ...
  try
  {
    ...
    Vector coef, soln, zxi, zcoef;
    Vector u, G_obs, eta, xi;
   
    double c, R, Z, form_var_r, form_var_z; 
    double c_tot=0.;
