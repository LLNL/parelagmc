...
#ifndef CREATESAMPLERPARAMETERLIST_HPP__
#define CREATESAMPLERPARAMETERLIST_HPP__
...
{
std::unique_ptr<parelag::ParameterList> CreateSamplerTestParameters()
{
    ...
    // Problem parameters
    {
        ...
        prob_params.Set("Lognormal",false);
        // KLSampler example parameters 
        prob_params.Set("Sampler name","analytic");
        prob_params.Set("Number of modes",std::vector<int>{4,4,4});
        prob_params.Set("Domain lengths",std::vector<double>{2.,2.,2.});
...
#endif /* CREATESAMPLERPARAMETERLIST */
