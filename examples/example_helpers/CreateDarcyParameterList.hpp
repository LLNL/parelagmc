...
#ifndef CREATEDARCYPARAMETERLIST_HPP__
#define CREATEDARCYPARAMETERLIST_HPP__
...
{
std::unique_ptr<parelag::ParameterList> CreateDarcyTestParameters()
{
    ...
    // Preconditioner Library
    {
        ...
        // PCG-AMG: Used for Form0 example 
        {
            auto& list = prec_lib.Sublist("PCG-AMG");
            list.Set("Type", "Krylov");
            {
                auto& solver_list = list.Sublist("Solver Parameters");
...
#endif /* CREATEDARCYPARAMETERLIST */
