...
// MLMC simulation for the mixed Darcy problem with the realizations of the 
// uncertain permeability coefficient generated using the SPDE sampler with 
