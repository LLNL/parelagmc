...
#ifndef SL_BAYESRATIO_SPLITTING_MANAGER_HPP_
#define SL_BAYESRATIO_SPLITTING_MANAGER_HPP_
...
namespace parelagmc
{
/// \class SL_BayesRatio_Splitting_Manager
/// \brief Class that implements a serial SL (splitting) ratio estimator manager
///
/// This computes E_post[Q] = E[R/Z] (divide, then sum i.e. compute MC estimate
/// of ratio) where R=Q\cdot \Pi_like and Z = \Pi_like.
...
class SL_BayesRatio_Splitting_Manager : public Sampling_Method_Manager
{
public:
    /// Constructor
    SL_BayesRatio_Splitting_Manager(MPI_Comm comm, 
        BayesianInverseProblem & problem,  
        parelag::ParameterList& params);

    /// Destructor
    virtual ~SL_BayesRatio_Splitting_Manager() = default;
    
    /// @{ \brief All special constructors and assignment are deleted
    SL_BayesRatio_Splitting_Manager() = delete;
    SL_BayesRatio_Splitting_Manager(SL_BayesRatio_Splitting_Manager const&) = delete;
    SL_BayesRatio_Splitting_Manager(SL_BayesRatio_Splitting_Manager&&) = delete;
    SL_BayesRatio_Splitting_Manager& operator=(SL_BayesRatio_Splitting_Manager const&) = delete;
    SL_BayesRatio_Splitting_Manager& operator=(SL_BayesRatio_Splitting_Manager&&) = delete;
    ///@}
...
SL_BayesRatio_Splitting_Manager::SL_BayesRatio_Splitting_Manager(MPI_Comm comm_, 
    ...
    wallTime(true)
{
    ...
    {
        std::cout << '\n' << std::string(50,'*') << '\n'
            << "*  SL_BayesRatio_Splitting_Manager \n"
            << "*    MSE: " << eps2 << '\n'
...
void SL_BayesRatio_Splitting_Manager::InitRun(
...
void SL_BayesRatio_Splitting_Manager::Run()
{
    sums    = 0.;
    expectations = 0.;
    eR        = 0.;
...
void SL_BayesRatio_Splitting_Manager::ShowMe(std::ostream & os)
{
    int total_width = 79;
    int name_width = 40;
    ...
    if(pid == 0)
    {
        ...
        os << "SL_BayesRatio_Splitting_Manager Errors: " << std::endl
...
//----------------------------------------------------------------------------------------------------------//
void SL_BayesRatio_Splitting_Manager::computeNSamplesMSE()
{
...
#endif /* SL_BayesRatio_Splitting_Manager_HPP_ */
